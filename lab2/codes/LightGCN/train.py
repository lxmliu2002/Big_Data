...
attrmap = LightGCN.map_attr_data(atrr_data, attr1_map, attr2_map, item_map)
train_data,train_edge = LightGCN.prepare_train_data(user_map, item_map, train_data, attrmap)
test_data,test_edge = LightGCN.prepare_train_data(user_map, item_map, test_data, attrmap)
model = LightGCN.LightGCN(num_users, num_items,  num_attr1, num_attr2)
LightGCN.train(model, train_data, train_edge, test_data,test_edge, num_epochs, lr, weight_decay,batch_size, device,gamma)
